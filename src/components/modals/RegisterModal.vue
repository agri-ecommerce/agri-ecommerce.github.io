        ...
        <div class="modal-inner" v-show="showModal">
          ...
          <div class="modal-content">
            ...
            <div class="content-container">
              <div class="input-label">เบอร์โทรศัพท์</div>
              <input type="text" />
              <div class="input-label">รหัสผ่าน</div>
              <input type="text" />
              <div class="input-label">ชื่อผู้ใช้งาน</div>
              <input type="text" />
            </div>
          </div>
          <div class="footer">
            <button @click="$emit('close')" class="btn-cancel">ยกเลิก</button>
            <button class="btn-confirm" @click="$emit('close')">ตกลง</button>
          </div>
        </div>
      </transition>
    </div>
